...
<p align="center">
  <img src="assets/railopsllm-overview.png" alt="RailIOpsLLM system overview" width="920">
</p>

<p align="center"><em>Figure 1. Overview of the RailIOpsLLM framework.</em></p>
...
| RailIOpsLLM LoRA (`checkpoint-7200`) | Yes | 256 | 52.8702 | 35.0510 | 36.7110 | 13.8758 | 80.2740 | **79.8591** |
| RailIOpsLLM LoRA (`checkpoint-7200`) | Yes | 512 | 55.6769 | 36.1768 | 37.2475 | 20.2500 | 80.3624 | 79.7227 |
| RailIOpsLLM LoRA (`checkpoint-7200`) | Yes | 1024 | **56.1948** | **36.4229** | **37.3637** | **22.4277** | **80.3624** | 79.7132 |
