"""Self-contained training configuration: train_configs/num_train_epochs/epoch_2.py."""
...
CONFIG = {'model_path': '/data16T/wjy/models/Qwen2.5-7B-Instruct',
 ...
 'experiment_name': 'qwen25_7b_data7236_lr4.5e-4_r64alpha64_epoch2_from_base',
