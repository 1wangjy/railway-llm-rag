"""Self-contained training configuration: train_configs/effective_batch_size/batch_2.py."""
...
CONFIG = {'model_path': '/data16T/wjy/models/Qwen2.5-7B-Instruct',
 ...
 'experiment_name': 'qwen25_7b_data7236_lr4.5e-4_effective_bs2_gacc2_from_base',
